const Man_Products = [
{
    ...
    prix: 1090 ,
    Description: 'Introducing Spring Summer 2026. This style is featured in the "Cocco di Mamma" and "Nerd" looks of La Famiglia. The new design puts an edgy twist on the classic Horsebit loafer, defined by a slim leather sole and reverse construction which provides a soft, comfortable and extremely flexible fit.',
    mainVideo: "./Media/Products/m/Shoes/pro1-vid.mp4",
    images: ["Media/Products/m/Shoes/pro1-im1.avif","Media/Products/m/Shoes/pro1-im2.avif","Media/Products/m/Shoes/pro1-im3.avif" ],
    wOrm: "M",
    category: "Shoes",
...
{
    id: 2,
    title: "Men's Stretch high-top sneaker",
    prix: 999 ,
    Description: "Introducing Spring Summer 2026. This style is featured in the 'Figo' look of La Famiglia. The new design reimagines the House's signature sneaker in a light, soft and flexible silhouette. Crafted from soft stretchy leather, the style has been treated by hand to achieve a worn-out appearance which makes every pair unique.",
    mainVideo: "Media/Products/m/Shoes/pro2-vid.mp4",
    images: ["Media/Products/m/Shoes/pro2-im-1.avif","Media/Products/m/Shoes/pro2-im-2.avif","Media/Products/m/Shoes/pro2-im-3.jpg" ],
    wOrm: "M",
    category: "Shoes",
...
},
{
    ...
    mainVideo: "Media/Products/m/Shoes/prod3-vid.mp4",
    images: ["Media/Products/m/Shoes/pro3-im1.avif","Media/Products/m/Shoes/pro3-im2.jpg","Media/Products/m/Shoes/pro3-im3.avif" ],
    wOrm: "M",
    category: "Shoes",
