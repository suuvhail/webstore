...
// ------------  mostrat productos en la cartolina -----------
...
function renderCart() {
    ...
    if (cart.length === 0) {
        cartItemsContainer.innerHTML = '<p class="text-muted text-center mt-5">Your bag is empty.</p>';
...
// Modificar la cantidad de los producto existen en la cartolina
...
// Eliminar el producto desde la cartolina
...
// añadir un producto a la cartolina 
...
// mostrat un mensaje que informa que el producto se ha añadido con exito 
...
// ACTUALIZAR EL NUMERO DE COUNT DE PRODUCTOS EXISTEN EN LA CARTOLINA
...
// ---------------------------------------- FINALE DE LA cartolina ------------------------------- // 


// esta funcion para hacer un mixo de los productos cada vez de manera aleatoria
...
// aqui configuramos el click de añadir producto a la cartolina
...
// en el codigo seguiente Actualizamos la cartolina numero de productos
...
document.querySelector('#cartOffcanvas .btn-dark').addEventListener('click', function(e) {
    e.preventDefault();
